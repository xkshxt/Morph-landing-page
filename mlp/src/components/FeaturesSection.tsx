  ...
  return (
    <section className="py-20 bg-blue-200">
      ...
      <div className="flex flex-wrap justify-center space-x-4 md:space-x-36 mb-20">
        <img src="https://cdn-icons-png.flaticon.com/128/732/732221.png" alt="Company 1" className="h-12" />
        <img src="https://cdn-icons-png.flaticon.com/128/731/731985.png" alt="Company 2" className="h-12" />
        <img src="https://cdn-icons-png.flaticon.com/128/2504/2504929.png" alt="Company 3" className="h-12" />
        <img src="https://cdn-icons-png.flaticon.com/128/5968/5968764.png" alt="Company 4" className="h-12" />
        <img src="https://cdn-icons-png.flaticon.com/128/5969/5969205.png" alt="Company 5" className="h-12" />
        <img src="https://cdn-icons-png.flaticon.com/128/5968/5968804.png" alt="Company 6" className="h-12" />
        <img src="https://cdn-icons-png.flaticon.com/128/5968/5968819.png" alt="Company 7" className="h-12" />
      </div>
