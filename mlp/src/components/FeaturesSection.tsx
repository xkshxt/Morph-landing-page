    ...
    <section className="py-20 bg-blue-200">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 px-4 md:px-40 mb-20">
        <div className="bg-white p-6 rounded-2xl shadow-md">
          <h3 className="text-2xl font-semibold mb-4">Design: Devtol's 100+ components and integrated IDE deliver the world's
          fastest development cycle.</h3>
          <img
        ...
        <div className="bg-white p-6 rounded-2xl shadow-md">
          <h3 className="text-2xl font-semibold mb-4">Code: Devtol is designed for developers, allowing you to code from
          virtually anywhere in the world.</h3>
          <img
        ...
        <div className="bg-white p-6 rounded-2xl shadow-md md:col-span-2">
          <h3 className="text-2xl font-semibold mb-4">Debug: Analyze stack traces, monitor query performance over time, inspect
          application state, and delve into all dependencies. Easily scale your applications to meet the demands of your growing business.</h3>
          <img
